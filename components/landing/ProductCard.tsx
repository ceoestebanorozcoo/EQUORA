  ...
  return (
    ...
    >
      ...
      <div className="p-4 md:p-5">
        ...
        <div className="w-full py-2.5 rounded-full bg-equora-dark hover:bg-[#4a2e1f] text-[#E7D6C2] font-body text-xs font-medium tracking-widest uppercase text-center transition-colors duration-300">
          Ver producto
        </div>
      </div>
    </Link>
