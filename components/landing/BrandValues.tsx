        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto items-stretch">
          {values.map((value, i) => (
            <ScrollReveal key={value.title} direction="up" delay={i * 150} className="h-full">
              <div className="group h-full text-center p-10 rounded-3xl border border-gray-200/50 hover:border-equora-amber/30 bg-white hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
